...
const ForgotPasswordController = {
    sendOtp: async (req, res) => {
        return res.status(400).send(
            Utility.formatResponse(400, {
                message: "Phone authentication must be initiated from the client side.",
            })
        );
    },
        ...
        try {
            ...
            return res.status(200).send(
                Utility.formatResponse(200, {
                    ...
                    data: decodedToken, // Contains user info like uid, phone number, etc.
                })
            );
        } catch (error) {
