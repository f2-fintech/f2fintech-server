...
const CustomerApplication = sequelize.define(
  "customer_application",
  {
    ...
    loan_type: {
      type: Sequelize.ENUM,
      values: ['personal loan', 'business loan', 'professional loan', 'home loan', 'education loan', 'lap', 'machinery loan', 'auto loan', 'just inquiry', 'doctor', 'ca_cs_cma'],
      allowNull: true
    },
    business_entity_type: {
      type: Sequelize.ENUM,
      values: ['sole_proprietorship', 'private_limited', 'llp', 'huf', 'partnership'],
      allowNull: true
    },
    lead_type: {
      type: Sequelize.ENUM,
